...
namespace Inspire
{
    ...
    namespace PropertyNames
    {
        ...
        const char menuTitle[] = "_inspire_toolButton_menutitle";
        const char alteredBackground[] = "_inspire_altered_background";
    }
...
Q_DECLARE_OPERATORS_FOR_FLAGS(Inspire::AnimationModes)
Q_DECLARE_OPERATORS_FOR_FLAGS(Inspire::Corners)
Q_DECLARE_OPERATORS_FOR_FLAGS(Inspire::Sides)
