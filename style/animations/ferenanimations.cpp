...
namespace Feren
{
    ...
    void Animations::setupEngines( void )
    {
        ...
        // animation steps
        AnimationData::setSteps( Feren::Config::AnimationSteps );

        bool animationsEnabled( Feren::Config::AnimationsEnabled );
        int animationsDuration( Feren::Config::AnimationsDuration );
        ...
        _stackedWidgetEngine->setEnabled( animationsEnabled && Feren::Config::StackedWidgetTransitionsEnabled );

        // busy indicator
        _busyIndicatorEngine->setEnabled( Feren::Config::ProgressBarAnimated );
        _busyIndicatorEngine->setDuration( Feren::Config::ProgressBarBusyStepDuration );
