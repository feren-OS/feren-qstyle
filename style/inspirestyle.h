...
#ifndef INSPIRE_STYLE_H
#define INSPIRE_STYLE_H
...
protected:
    ...
    virtual bool drawToolBarEmptyArea(const QStyleOption *option, QPainter *painter, const QWidget *widget) const;
...
private:
    ...
    //* tabbar data
    InspirePrivate::TabBarData *_tabBarData;
